...
//
//    private static final String READ_CERTIFICATES = "SELECT" +
...
//            " LEFT JOIN tags_gift_certificates ON gift_certificates.id = tags_gift_certificates.certificate_id" +
//            " LEFT JOIN tags ON tags.id = tags_gift_certificates.tag_id";
//
//
//
//
...
//
//
//    private static final String READ_CERTIFICATES_BY_TAGS = "SELECT" +
//            "  gift_certificates.id," +
//            "  gift_certificates.name," +
//            "  gift_certificates.description," +
//            "  gift_certificates.price," +
...
//            "  gift_certificates.create_date," +
//            "  gift_certificates.last_update_date" +
//            " FROM tags_gift_certificates" +
//            " INNER JOIN tags ON tags.id = tags_gift_certificates.tag_id" +
//            " INNER JOIN gift_certificates ON gift_certificates.id = tags_gift_certificates.certificate_id" +
//            " WHERE tags.name IN (%s)" +
//            " GROUP BY gift_certificates.id" +
//            " HAVING COUNT(gift_certificates.id) = %i";
//
...
//        if (searchData.getTagNames() != null) {
//            queryParameters.addAll(searchData.getTagNames());
